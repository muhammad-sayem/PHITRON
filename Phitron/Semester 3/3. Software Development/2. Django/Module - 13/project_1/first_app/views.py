...
def DjangoForm(request):
    if request.method == 'POST':
        form = contactForm(request.POST, request.FILES)     # request.POST deya hoy int, string ei values gula pauar jonno ar request.FILES deya hoy files gulo ke pauar jonno
        if form.is_valid():
